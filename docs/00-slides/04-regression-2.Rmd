...
## 1. Review of bivariate regression
...
- **Regression**: what is the *best fitting* straight line to capture the relationship of two variables in a *scatter plot*? 
--
 See ROS Ch. 6.4 for a conceptual history of the term 'regression to the mean' 
