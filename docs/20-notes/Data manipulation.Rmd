...
## Changing the variable types on imported datasets

```{r}
## from the 'labelled' package, the unlabelled function can be useful for simple transformation of a whole dataset. (https://cran.r-project.org/web/packages/labelled/vignettes/intro_labelled.html)
# see:
glimpse(small_evs)
# vs.
glimpse(small_evs |> labelled::unlabelled())
```
