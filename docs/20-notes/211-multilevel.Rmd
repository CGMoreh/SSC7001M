---
title: "Week 12: Multilevel/longitudinal models"
output:
...
```
Or we can generate a more complete summary table:
...
# Use the command:
# view(dfSummary(ost))
# to generate a separate document in the viewer to treat as a data dictionary
```
